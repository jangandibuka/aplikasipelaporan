...
class Auth extends CI_Controller
{
    ...
    function member()
    {
        ...
        } elseif (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
        {
            ...
            return show_error('Anda bukan administrator.');
        } else {
            ...
            $this->data['pic'] = '';
            //echo "<pre>";print_r($this->data['tb_users']);echo "</pre>";
    ...
    function create_user()
    {
        ...
        if ($identity_column !== 'email') {
            ...
            $this->form_validation->set_rules('email', $this->lang->line('create_user_validation_email_label'), 'required|valid_email|is_unique[' . $tables['tb_users'] . '.email]');
        }
        ...
        if ($this->form_validation->run() == true) {
            $idkampus = $this->input->post('id_kampus');
            $email = strtolower($this->input->post('email'));
            $identity = ($identity_column === 'email') ? $email : $this->input->post('identity');
            $password = $this->input->post('password');
            $querytypeInstansi = "SELECT * FROM mst_kampus mk JOIN mst_instansi_type mit ON mit.id=mk.id_instansi_type WHERE mk.id='$idkampus'";
            $result = $this->db->query($querytypeInstansi)->row();
            $company = $result->instansi;
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
            ...
            $this->data['kampus'] = $this->Kampus_model->get_all();
            $this->template->display('auth/create_user', $this->data);
        }
    }
    ...
    function register()
    {
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
            ...
            $this->load->view('auth/registrasi_user', $this->data);
        }
    }
    ...
    function edit_user($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'first_name'    => set_value('First Name', $row->first_name),
                'last_name'    => set_value('Last Name', $row->last_name),
                'id_kampus'     => set_value('id_kampus', $row->id_kampus),
                'uid' => $this->session->userdata('user_id'),
                'message' => '',
            );
            $data['kampus'] = $this->Kampus_model->get_all();
            $this->template->display('auth/edit_user', $data);
        } else {
    ...
    function update_user()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $idkampus = $this->input->post('id_kampus', TRUE);
            $querytypeInstansi = "SELECT * FROM mst_kampus mk JOIN mst_instansi_type mit ON mit.id=mk.id_instansi_type WHERE mk.id='$idkampus'";
            $result = $this->db->query($querytypeInstansi)->row();
            $company = $result->instansi;
            $data = array(
    ...
    function profile($id)
    {
        ...
        if ($row) {
            ...
            $this->template->display('auth/profile', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
