...
$config['tables']['tb_login_attempts'] = 'tb_login_attempts';
...
$config['salt_prefix'] = version_compare(PHP_VERSION, '7.3.33', '<') ? '$2a$' : '$2y$';
 ...
 */
$config['site_title'] = "APLIKASI PELAPORAN";       // Site Title, example.com
$config['admin_email'] = "ibnuzamrud@gmail.com"; // Admin Email, admin@example.com
...
$config['email_config'] = array( 'mailtype' => 'text', 
    'protocol' => 'smtp', 
