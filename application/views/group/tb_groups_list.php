<section class='content-header'>
	...
	<ol class='breadcrumb'>
		...
		<li class='active'>Daftar Grups</li>
	</ol>
</section>
							...
							?>
								<tr>
									...
									<td style="text-align:center" width="140px">
										...
										echo '  ';
										echo anchor(site_url('groups/delete/' . $groups->id), '<i class="fa fa-trash-o"></i>', 'data-toggle="tooltip" title="delete" class="btn btn-info btn-sm tombol-hapus"');
										?>
									</td>
								</tr>
							<?php
