                ...
                <div class="box-body table-responsive">
                    <table id="mytable" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        foreach ($tb_users as $user) {
                            if ($user->id_kampus == 0) {
                                $kampus = "Administrator";
                            } else {
                                $kampus = "namakampus";
                            }
                            $nk = $this->db->get_where('mst_kampus', array('id' => $user->id_kampus))->result();
                            foreach ($nk as $k) {
                                $kampus = $k->kampus;
                            }
                            echo "
                        ...
                        <?php echo "
                               ...
                               <td>" . anchor('auth/delete/' . $user->id, '<i class="btn-sm btn-info glyphicon glyphicon-trash" data-toggle="tooltip" title="Delete"></i>', array('class' => 'tombol-hapus',)) . "</td>
