        ...
        <div class='col-md-12'>
            ...
            <div class='box box-primary'>
                <div class='box-header'>
                    <div class='col-md-5'>
                        <?php
                        echo form_open('kampus/update_action');
                        ?>
                        <div class='box-body'>
                            <div class='form-group'>Nama Kampus                                
                                <input type="text" class="form-control" name="kampus" id="kampus" placeholder="Nama Kampus" value="<?php echo $kampus ?>" />
                            </div>
                            <div class='form-group'>Pimpinan Kampus <?php echo form_error('pimpinan') ?>
