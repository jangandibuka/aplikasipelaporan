<header class="main-header">
    <a href="<?php echo site_url('dashboard'); ?> " class="logo">
        ...
        <span class="logo-lg"><b>PIC <?php echo $this->session->userdata('nama_toko'); ?></b></span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo site_url('auth/logout'); ?>" class="btn btn-default btn-flat logout">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
